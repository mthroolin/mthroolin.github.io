...
I have since earned a master's degree at Montana State University, where I wrote an unpublished brief introduction to directed acyclic graphs and markov equivalence in a causal inference framework. There, I was funded as a teaching assistant, but also did some consulting with a researcher doing experiments with livestock. Results from my collaborations with this researcher have been presented at multiple conferences and will soon be published in a journal.
